...
preços. Você foi contratado para desenvolver o programa que monta esta tabela
de preços, que conterá os preços de 1 até 50 produtos, conforme o
exemplo abaixo:
...
n = int(input("Informe quantos ites o cliente está levando: "))
while n > 50:
    print("A quantidade não pode ser maior que 50 itens!")
    n = int(input("Informe quantos ites o cliente está levando: "))

print("{} iten(s) da o valor de R${}".format(n, n * 1.99))
